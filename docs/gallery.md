...
|-------|------|-----------|-------|-------------|
| `short-anime-v1.mp3` | [short-anime-v1](https://github.com/yao-project/yao/tree/main/gallery/short-anime-v1/) | stochastic (seed=42, temp=0.5) | 681 | 28-second anime J-rock opening in Bb major, 165 BPM. Electric guitar lead with driving energy. |
| `short-string-v1.mp3` | [short-string-v1](https://github.com/yao-project/yao/tree/main/gallery/short-string-v1/) | stochastic (seed=42, temp=0.4) | 113 | 29-second Romantic-era string ensemble miniature in A major, 90 BPM. Elegant and tender. |
| `short-jazz-v1.mp3` | [short-jazz-v1](https://github.com/yao-project/yao/tree/main/gallery/short-jazz-v1/) | stochastic (seed=42, temp=0.4) | 169 | 30-second cool jazz for a midnight bar in Bb minor, 80 BPM. Tenor sax melody with piano, contrabass, drums, and bell. |
| `puzzle-light.mp3` | [puzzle-light](https://github.com/yao-project/yao/tree/main/gallery/puzzle-light/) | stochastic (seed=42, temp=0.4) | 229 | 29-second light puzzle game BGM in C major, 90 BPM. Loopable and cheerful. |
