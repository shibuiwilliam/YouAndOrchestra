# Design: Surprise Score (Phase γ.1)

## Problem
YaO generates spec-correct music that can be predictable and flat — the Prosaic Output Problem (PROJECT.md §11.1).
...
- Future: Note Realizers can query surprise to inject variation
