...
YaO supports 40 instruments across 9 families. Each has a defined MIDI range and General MIDI program number, centralized in `src/yao/constants/instruments.py`.
